...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    "common.synced": "API connected",
    "common.offline": "API unreachable",
  ...
  sw: {
    ...
    "nav.signout": "Toka",
    "common.synced": "Imeunganishwa",
    "common.offline": "API haipatikani",
  ...
  fr: {
    ...
    "common.synced": "API connectée",
    "common.offline": "API inaccessible",
